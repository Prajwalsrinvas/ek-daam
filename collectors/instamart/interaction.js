...
// Per-pod delivery SLA, shaped like {"<podId>":6,"<podId>":12}. Item-level `sla` is null in the
// sample, so this config map is the real ETA source (N mins == the header "N mins Delivery to ...").
